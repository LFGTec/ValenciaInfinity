...
export function Juego() {
  ...
  const unityGameBaseUrl = "https://teal-bienenstitch-1469b9.netlify.app";
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-3">
            <div className="bg-card border-2 border-border rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="bg-white border-b-2 border-border p-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-vcf-red rounded-full animate-pulse"></div>
                  <span className="text-vcf-orange font-bold text-sm md:text-base">
                    MESTALLA RIVALS
                  </span>
                </div>
              ...
              <div
                ...
                style={{ height: "calc(100vh - 300px)", minHeight: "560px" }}
              >
                {!isGameLoaded ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-white/90 text-lg md:text-xl mb-8 drop-shadow-lg max-w-2xl">
                          Crea o únete a un lobby, espera a tu rival y compite
                          para meter más goles antes de que termine el tiempo.
                        </p>
                      </div>
          ...
          <div className="xl:col-span-1 space-y-4">
                ...
                <div className="p-4 space-y-4">
                  <div>
                    <h4 className="font-bold text-foreground mb-2 flex items-center gap-2 text-sm">
                      <div className="w-5 h-5 bg-vcf-orange rounded-full flex items-center justify-center text-white text-xs font-bold">
                        1
                      </div>
                      Crea o únete a un lobby
                    </h4>
                    <p className="text-xs text-muted-foreground ml-7">
                      Escribe un código de lobby y presiona{" "}
                      <strong>Crear Lobby</strong> o{" "}
                      <strong>Unirse a Lobby</strong> para jugar con otra
                      persona.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground ml-7">
                      Cuando haya dos jugadores conectados, aparecerá el mensaje
                      de inicio y la partida cargará automáticamente.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground ml-7">
                      Mantén presionado el botón de carrera para cargar la
                      fuerza de tu movimiento.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground ml-7">
                      Mientras mantienes presionado, mueve el mouse para elegir
                      la dirección hacia donde saldrá tu jugador.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground ml-7">
                      Suelta el botón para impulsarte, golpear la pelota y
                      anotar en la portería rival antes de que termine el
                      tiempo.
                    </p>
                  </div>
            ...
            <div className="bg-card border-2 border-border rounded-2xl p-4 shadow-lg">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Marca más goles que tu rival antes de que acabe el tiempo. Usa
                bien la dirección de la flecha, calcula la fuerza y aprovecha
                los rebotes.
              </p>
            </div>
          </div>
