...
import { SeasonRewind } from '../components/features/SeasonRewind';
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 py-12 bg-content">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {[
          { icon: Video, title: 'MATCH ROOMS', desc: 'Ve los partidos en directo con tus amigos', link: 'match-rooms' },
          { icon: BookOpen, title: 'ÁLBUM DE CARTAS', desc: 'Colecciona y completa tu álbum', link: 'album' },
          { icon: Gamepad2, title: 'TRIVIAS & QUIZZES', desc: 'Demuestra tus conocimientos', link: '/trivias' },
          { icon: Share2, title: 'INTERCAMBIO', desc: 'Comercia cartas con otros fans', link: 'exchange' },
          { icon: Globe, title: 'MUNDO VIRTUAL', desc: 'Explora y conecta globalmente', link: 'virtual-world' },
