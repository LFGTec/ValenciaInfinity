                        ...
                        <div className="relative grid gap-8 lg:grid-cols-[1.35fr_0.9fr] lg:items-center">
                            <div>
                                ...
                                <p className="mt-4 max-w-2xl text-base md:text-lg font-medium text-gray-700">
                                    Completa trivias, asiste a partidos y participa en eventos para ganar sobres gratis.
                                </p>
                            ...
                            <div className="relative rounded-2xl border-2 border-black/10 bg-white p-5 shadow-lg">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { title: "Trivias", desc: "Responde preguntas y suma sobres gratis." },
                                        { title: "Partidos", desc: "Participa en la experiencia del equipo." },
                                        { title: "Intercambios", desc: "Completa tu colección con otros fans." },
                                    ].map((item) => (
                                        <div
                                            key={item.title}
