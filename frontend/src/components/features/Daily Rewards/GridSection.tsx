...
const getRewardColor = (type: DayReward["type"]) => {
  switch (type) {
    case "points": return "bg-vcf-orange";
    case "card":   return "bg-purple-600";
    case "bonus":  return "bg-gradient-to-r from-vcf-orange to-vcf-yellow";
  }
};
...
const getRewardIcon = (type: DayReward["type"]) => {
  switch (type) {
    ...
    case "card":   return Trophy;
    case "bonus":  return Crown;
  }
};
        ...
        {rewards.map((reward) => {
          ...
          return (
            ...
            >
              ...
              <div className={`w-16 h-16 mx-auto mb-3 rounded-full flex items-center justify-center ${colorClass}`}>
                <Icon size={32} className="text-white" />
              </div>

              <div className="text-center mb-2">
                <div className="text-2xl font-black text-foreground mb-1">
                  {reward.type === "points" || reward.type === "bonus" ? `+${reward.reward}` : "CARTA"}
                </div>
